        ...
        const _memberData = [
            {
                ...
                phone: "333-333-3333",
                venmo: "big-wang-69",
                address: { _id: "9d9e8e3f-67c6-4c72-9720-e9fe46ae9a2e", address: "422 Monroe St", city: "Hoboken", state: "NJ", zipcode: "07030" },
                driver: true,
                passenger: true,
                history: [{ _id: "70abf263-c8ec-4729-b3c8-3db651979cc1", name: "Jordan Wang's Dance Party", date: "04/01/2022", carpool: "3e90e42d-bcd2-411e-9057-9b8da947a001" }],
            },
        ];
...
//             const carpoolData = await carpools.get(id);
//             const { driver, departureTime, capacity, members } = { carpoolData };
//             const templateData = {
//                 driver: driver,
...
//             return res.render("templates/pool", templateData);
//         } catch (e) {
//             const states = Object.keys(US_States);
//             const templateData = {
//                 error: e,
...
router.route("/join/:id").get(async (req, res) => {
